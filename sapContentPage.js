  ...
  var R = {
    ...
    InputWidget: {
      ...
      prepareDatePickerYearDropDown: function (y) {
        var d = R.Setting.get(y, 'dropdowntype'), Y = d.split('-'), i, a, o = new Date(), b = o.getFullYear(), e, I;
        if (Y.length === 4) {
          i = (parseInt(Y[2], 10) || 0);
          a = (parseInt(Y[3], 10) || 0);
        }
      ...
      applyPersonalization: function (i, v) {
        var I = R.Node.getFirstWithClassName(i, 'sapCpInput'), o = R.Node.getFirstWithClassName(i, 'sapCpCheckBox'),
          d = R.Node.getFirstWithClassName(i, 'sapCpDatePicker'), D = R.Node.getFirstWithClassName(i, 'sapCpDropDown'),
          a;
        if (!v) {
          return;
        }
      ...
      updateDatePickerValues: function (d) {
        ...
        var s = D.selectedOptions[0].value, S = m.selectedOptions[0].value, a = y.selectedOptions[0].value,
          i = (parseInt(s, 10) || 0), b = (parseInt(S, 10) || 0), e = (parseInt(a, 10) || 0), o = new Date(e, b, 0),
          f = o.getDate(), O = D.options.length, g, I;
        if (i > f) {
      ...
      collectAnswer: function (i) {
        var I = R.Widget.isMandatory(i), o = R.Node.getFirstWithClassName(i, 'sapCpInput'),
          a = R.Node.getFirstWithClassName(i, 'sapCpCheckBox'), d = R.Node.getFirstWithClassName(i, 'sapCpDatePicker'),
